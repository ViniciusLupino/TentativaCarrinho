    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbCategoriaProduto", x => x.IdCategoriaProduto);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoriaProdutoIdCategoriaProduto = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tbProduto_AspNetUsers_UsuarioId",
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.CategoriaProdutoIdCategoriaProduto,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsuarioId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProdutosId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProdutoIdProduto = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbCarrinho", x => x.IdCarrinho);
                    table.ForeignKey(
                        name: "FK_tbCarrinho_AspNetUsers_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_tbCarrinho_tbProduto_ProdutoIdProduto",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tbCarrinho_ProdutoIdProduto",
                table: "tbCarrinho",
                column: "ProdutoIdProduto");

            migrationBuilder.CreateIndex(
                name: "IX_tbCarrinho_UsuarioId",
                table: "tbCarrinho",
                column: "UsuarioId");
